...
const GetUser = (userName) => {
    const URL_API = `/api/User/${userName}`;
    return api.get(URL_API);
};
...
const AddUser = (data) => {
    const URL_API = "/api/User/add";
    return api.post(URL_API, data);
};

const AdminUpdateUser = (data) => {
    const URL_API = "/api/User/admin/update";
    return api.put(URL_API, data);
};
...
const ForgotPassword = (email) => {
    const URL_API = `/api/User/forgot-password?email=${email}`;
...
const SendEmailConfirmation = (email) => {
    const URL_API = `/api/User/send-email-confirmation?email=${email}`;
    return api.post(URL_API);
};

const ConfirmEmail = (email, token) => {
    const URL_API = `/api/User/confirm-email?email=${email}&token=${token}`;
    return api.post(URL_API);
};

const UpdateAvatar = (userName, url) => {
    const URL_API = `/api/User/${userName}/avatar`;
